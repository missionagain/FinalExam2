...
<div class="g-doc">
    ...
    <div class="n-show f-cb" id="showContent">
        ...
        <div class="cnt">
            ...
            <#if !user??>
           <div class="price">
                <span class="v-unit">¥</span><span class="v-value">${product.price*0.01}</span>
            </div>
           </#if>
    <#--       <#if user?? && user.userType==1 || !product.isBuy>
           <div class="price">
     ...
     --> 
            ...
            <div class="oprt f-cb">
                <#if user?? && user.userType==0>
                    ...
                    <span class="buyprice">当时购买价格：¥${trxProduct.price*0.01}</span>
                    <#else>
